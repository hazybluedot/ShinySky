...
textInput.typeahead <- function(id,placeholder,local, valueKey, tokens,template,limit = 20) {
  shiny::tagList(
    ...
    , shiny::HTML(sprintf('<input id="%s" data-name="%s" type="text" value="" class="input typeahead" placeholder="%s" autocomplete="off" spellcheck="false" style="margin: 0 auto;"/>',id,id,placeholder))
